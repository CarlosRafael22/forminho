...
describe('Test fieldValidator', () => {
    it('should not pass on min()', () => {
        ...
        fieldValidator('test', 'firstName', mockedSet, mockedClear).min(6, 'Should have more than 6 letters').max(10, 'Should have less than 6 letters')
    ...
    it('should pass on min() but not on max()', () => {
        ...
        fieldValidator('testinho name', 'firstName', mockedSet, mockedClear).min(6, 'Should have more than 6 letters').max(10, 'Should have less than 10 letters')
    ...
    it('should not pass on required()', () => {
        ...
        fieldValidator('', 'firstName', mockedSet, mockedClear).required().min(6, 'Should have more than 6 letters').max(10, 'Should have less than 10 letters')
